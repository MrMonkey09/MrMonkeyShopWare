...
Cómo obtener ayuda con MrMonkeyShopWare.
...
### Tutoriales
- [Pipeline Completo](./tutoriales/pipeline-completo.md)
...
| Canal | Respuesta esperada |
|-------|-------------------|
| Bugs críticos | 24-48 horas |
| Bugs normales | 1 semana |
| Features | 2 semanas |
| Discusiones | Best effort |
